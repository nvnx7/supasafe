    ...
    <div
      ...
      className={cn(
        ...
        variant === "brand"
          ...
          : "bg-card text-card-foreground shadow-[0_1px_3px_0_rgb(6_44_34_/_0.03),0_4px_16px_-2px_rgb(6_44_34_/_0.02)] ring-1 ring-border",
        className,
      )}
      {...props}
    />
...
function CardDescription({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "text-sm text-muted-foreground group-data-[variant=brand]/card:text-primary-foreground/65",
        className,
      )}
      {...props}
    />
